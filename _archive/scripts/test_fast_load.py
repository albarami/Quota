#!/usr/bin/env python
"""Test fast data loading from summary."""
...
for code in test_codes:
    ...
    if data:
        ...
        print(f"{code}: Stock={stock:>8,} | Cap={cap:>8,} | Util={util:>6.1%} | Headroom={headroom:>8,} | Alerts={alerts} [{source}]")
...
print(f"\nTotal load time for all 12 nationalities: {elapsed:.3f}s")

    ...
    for code, metrics in summary['nationalities'].items():
        if isinstance(metrics, dict) and 'current_stock' in metrics:
            compat_summary['nationalities'][code] = {
                ...
                'in_country': metrics['current_stock'],  # Alias
                ...
                # v4 flow data - CRITICAL for accurate calculations
                'avg_annual_joiners': metrics.get('avg_annual_joiners', 0),
                'avg_annual_outflow': metrics.get('avg_annual_outflow', 0),
                'joined_2024': metrics.get('joined_2024', 0),
                'joined_2025': metrics.get('joined_2025', 0),
                'left_2024': metrics.get('left_2024', 0),
                'left_2025': metrics.get('left_2025', 0),
                'monthly_allocation': metrics.get('monthly_allocation'),
                'demand_basis': metrics.get('demand_basis'),
                'demand_value': metrics.get('demand_value', 0),
                'buffer_pct': metrics.get('buffer_pct', 0),
                'buffer_value': metrics.get('buffer_value', 0),
                'desired_cap': metrics.get('desired_cap', 0),
                ...
                'growth_direction': metrics.get('growth_direction'),
